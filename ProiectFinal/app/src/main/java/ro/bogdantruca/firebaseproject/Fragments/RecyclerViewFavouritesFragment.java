 ...
 */
public class RecyclerViewFavouritesFragment extends Fragment implements Constants {
    ...
    public RecyclerViewFavouritesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_recycler_view_favourites, container, false);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for(DocumentSnapshot documentSnapshot: task.getResult()) {
                            ...
                            if(documentSnapshot.get(DB_FAVORITE , boolean.class) == true) {
